...
case $choose in
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-Port-All_$DATE
	...
	while [ $num -le $line ]
	     ...
	     echo "$num.Switch IP: $address ... config read"
             ./site_4-NAC-Sw-Port.exp $address $username $password > $DIR/$address 2>&1
	     num=$(( $num + 1 ));
	     sleep 1
	     done
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-Port-Indv_$DATE
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-Auth-All_$DATE
	...
	while [ $num -le $line ]
	     ...
	     echo "$num.Switch IP: $address ... data read"
             ./site_4-NAC-Sw-Auth.exp $address $username $password > $DIR/$address 2>&1
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-Auth-Indv_$DATE
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-Mac-List-All_$DATE
	...
	while [ $num -le $line ]
	     ...
	     echo "$num.Switch IP: $address ... Data read"
             ./site_4-Sw-Mac-List.exp $address $username $password > $DIR/$address 2>&1
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-Mac-List-Indv_$DATE
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-Mac-Search_$DATE
	...
	echo "*********************************** "
           ...
           ./site_4-Sw-Mac-List-Search.exp $address $username $password $mac > $DIR/$address 2>&1
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-VlanPortList-All_$DATE
	...
	while [ $num -le $line ]
	     ...
	     echo "$num.Switch IP: $address ... saved"
             ./site_4-Sw-VlanList.exp $address $username $password > $DIR/$address 2>&1
	...
	DATE=`date +%F`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-Sw-VlanPortList-Indv_$DATE
	...
	DATE=`date +%F_%H%M`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-logsw-config_$DATE
	...
	echo "************************************ "
           ...
           ./site_4-NAC-ConfigSw.exp $address $username $password $port > $DIR/$address 2>&1
	...
	DATE=`date +%F_%H%M`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-logsw-config-ext_$DATE
	...
	DATE=`date +%F_%H%M`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-logsw-Revert_$DATE
	...
	echo -n "Input A Switch Port [E.g. 1/20]: " 
	read port
	echo "*[Note: User @12&04 Floor is 101 and User @13F is 102]*" 
	echo -n "Input User Vlan [e.g. 101 or 102]: " 
	read vlan
	echo "***************************************************** "

         ./site_4-NAC-ConfigSw-Revert.exp $address $username $password $port $vlan > $DIR/$address 2>&1		
	...
	DATE=`date +%F_%H%M`
	MONTH=`date +%b-%y`
	DIR=~/script/logs/site_4-NAC-Sw/$MONTH/site_4-NAC-logsw-VerifyPort_$DATE
	...
	echo "******************************************* "
        ...
        ./site_4-NAC-ConfigSw-VerifyPort.exp $address $username $password $port > $DIR/$address 2>&1
